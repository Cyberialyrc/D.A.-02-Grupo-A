...
FECHA: 29/09/24
DESCRIPCIÓN: Archivo de entrada principal de la aplicación que renderiza el componente `App` en el DOM, asegurando que el componente que usa `useState` sea correctamente montado.
*************************************************************************************************/
